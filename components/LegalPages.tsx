    ...
    const renderContent = () => {
        switch(page) {
            case 'about':
                return (
                    <>
                        <h1>About <span className="highlight">GeminiVision</span></h1>
                        <p style={{marginTop:'20px', lineHeight:'1.6', color:'var(--text-muted)'}}>
                            GeminiVision Studio is a cutting-edge tool designed for creators, stock photographers, and AI video artists. 
                            Leveraging the power of Google's Gemini 2.5 Flash model, we automate the tedious parts of your workflow.
                        </p>
                ...
                return (
                    <>
                        ...
                        <p style={{marginTop:'5px', lineHeight:'1.6', color:'var(--text-muted)'}}>
                            GeminiVision Studio operates as a client-side application. Your images are processed locally in your browser 
                            to resize them before being sent directly to Google's Gemini API using your own API key. We do not store 
                            your images or API keys on our servers.
                        </p>
                        <h3 style={{marginTop:'20px', color:'var(--text-main)'}}>2. API Keys</h3>
                        <p style={{marginTop:'5px', lineHeight:'1.6', color:'var(--text-muted)'}}>
                            Your Google Gemini API keys are stored exclusively in your browser's LocalStorage. You are responsible for keeping your keys secure.
                        </p>
                    </>
                );
            case 'terms':
                return (
                    <>
                        ...
                        <p style={{marginTop:'20px', lineHeight:'1.6', color:'var(--text-muted)'}}>
                            By using GeminiVision Studio, you agree to the following terms:
                        </p>
                        <ul style={{marginTop:'15px', paddingLeft:'20px', color:'var(--text-muted)', lineHeight:'1.8'}}>
                            <li>You must provide your own valid Google Gemini API key.</li>
                            ...
                            <li>We are not affiliated with Adobe Stock, Runway ML, or Google.</li>
                        </ul>
                    </>
                );
            case 'contact':
                return (
                    <>
                        ...
                        <div style={{marginTop:'30px', padding:'20px', background:'var(--bg-input)', borderRadius:'12px', border:'1px solid var(--border-color)'}}>
                            ...
                            <p style={{color:'var(--accent-cyan)', marginTop:'5px'}}>support@geminivision.studio</p>
                        </div>
                    </>
                );
            default:
